...
{
   float result;
   result = sqrtf(powf((x1 - x2), 2.0) + powf((y1 - y2), 2.0) + powf((z1 - z2), 2.0));
   return (result);
}
                  ...
                  if ((i < WORLDX) && (j < WORLDY) && (k < WORLDZ) && (i > -1) && (j > -1) && (k > -1))
                         ...
                         (CubeInFrustum(i + 0.5, j + 0.5, k + 0.5, 0.5)))
                     {
                        ...
                        if ((i > 0) && (i < WORLDX - 1) &&
                            (j > 0) && (j < WORLDY - 1) &&
                            (k > 0) && (k < WORLDZ - 1) &&
                            ((world[i + 1][j][k] == 0) || (world[i - 1][j][k] == 0) || (world[i][j + 1][k] == 0) || (world[i][j - 1][k] == 0) || (world[i][j][k + 1] == 0) || (world[i][j][k - 1] == 0)))
